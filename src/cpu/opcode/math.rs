...
pub fn set_reg(cpu: &mut Cpu, args: &Args) {
    cpu.v[args.x as usize] = cpu.v[args.y as usize];
}
...
pub fn add_reg(cpu: &mut Cpu, args: &Args) {
    let a = cpu.v[args.x as usize] as u16;
    let b = cpu.v[args.y as usize] as u16;
...
pub fn sub_reg(cpu: &mut Cpu, args: &Args) {
    let a = cpu.v[args.x as usize] as i16;
    let b = cpu.v[args.y as usize] as i16;
...
pub fn right_shift_reg(cpu: &mut Cpu, args: &Args) {
    ...
    cpu.v[0xF] = cpu.v[args.x as usize] & 0b00000001;
    cpu.v[args.x as usize] >>= 1;
}
...
pub fn sub_reg_store(cpu: &mut Cpu, args: &Args) {
    ...
    cpu.v[args.x as usize] = cpu.v[args.y as usize] - cpu.v[args.x as usize];
}
